        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/31686411124" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors">
              ...
              <a href="mailto:info@013transport.eu" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#f98b67] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'Diensten', 'Vacatures', 'Over Ons', 'Contact'].map((item) => (
                <li key={item}>
                  <Link href={item === 'Home' ? '/' : `/${item.toLowerCase().replace(' ', '-')}`} className="text-white/70 hover:text-[#f98b67] transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
